      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
          <div className="flex-1 order-2 md:order-1 px-2 md:px-0">
            ...
            >
              Quem está por trás do Pack DE AGENDAS?
            </h2>

            <h3
              className="text-lg mb-4"
              style={{ fontFamily: "Poppins, sans-serif", color: "#FFDF00", fontWeight: 700 }}
            >
              Jonathan Spósito
            </h3>

            <p style={{ fontFamily: "Sora, sans-serif", color: "rgba(255,255,255,0.85)", lineHeight: 1.7, marginBottom: "16px" }}>
              Sou um norte mineiro, Designer Gráfico e Motion Designer especializado em{" "}
              <strong style={{ color: "#FFFFFF" }}>Identidades Visuais e Marketing para Eventos.</strong>
            </p>

            <p style={{ fontFamily: "Sora, sans-serif", color: "rgba(255,255,255,0.85)", lineHeight: 1.7, marginBottom: "16px" }}>
              Atuo no mercado desde 2014 atendendo produtores de eventos de diversos países e{" "}
              <strong style={{ color: "#FFDF00" }}>já faturei + de R$192mil com o mercado de eventos.</strong>
            </p>

            <p style={{ fontFamily: "Sora, sans-serif", color: "rgba(255,255,255,0.85)", lineHeight: 1.7, marginBottom: "24px" }}>
            ...
            <div className="flex items-center gap-4">
              <a
                href="https://www.instagram.com/jonathandesigner/"
                target="_blank"
              ...
              <a
                href="https://api.whatsapp.com/send/?phone=%2B5533988819891"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full flex items-center justify-center text-white hover:bg-white/10 transition-colors"
                style={{ border: "1px solid rgba(255,255,255,0.3)" }}
            ...
            <div className="relative">
              <div className="md:hidden absolute bottom-3 left-3 flex gap-2 z-10">
                <span
                  ...
                  style={{ backgroundColor: "rgba(0,0,0,0.7)", border: "1px solid #FFDF00", color: "#FFDF00" }}
                >
                  EXPERT EM EVENTOS
                </span>
                <span
              ...
              <div className="hidden md:flex absolute bottom-4 left-1/2 -translate-x-1/2 gap-3 z-10 whitespace-nowrap">
                <span
                  className="text-xs font-bold px-4 py-2 rounded-full bg-transparent"
                  style={{ border: "2px solid #FFDF00", color: "#FFDF00" }}
                >
                  EXPERT EM EVENTOS
                </span>
                <span
...
export default AboutSectionAgendas;