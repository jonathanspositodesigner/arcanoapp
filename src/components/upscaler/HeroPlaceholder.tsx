    ...
    >
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <button 
          ...
          className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-slate-500 to-slate-500 text-foreground font-semibold rounded-full shadow-xl shadow-primary/10 transition-transform animate-pulse hover:animate-none hover:scale-105"
        >
