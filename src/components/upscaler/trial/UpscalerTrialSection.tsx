  ...
  return (
    <div className="px-4 py-20 bg-muted/50">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-muted-foreground/70 text-center mb-10 max-w-xl mx-auto">
              ...
              <div className="absolute inset-0 bg-black/60 backdrop-blur-sm rounded-2xl flex flex-col items-center justify-center gap-6 z-10">
                {phase === "locked" ? (
                  <>
                    ...
                    <p className="text-muted-foreground/60 text-sm">1 upscale gratuito • Sem compromisso</p>
                  </>
                ) : (
