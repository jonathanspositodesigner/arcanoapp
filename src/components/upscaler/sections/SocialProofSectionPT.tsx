  ...
  const TestimonialCard = ({ result, index }: { result: typeof userResults[0]; index: number }) => (
    <div className="bg-white/5 border border-white/10 rounded-2xl overflow-hidden hover:border-fuchsia-500/30 transition-all duration-300">
      <div className="flex flex-col md:flex-row">
        ...
        <div className="p-3 md:p-6 md:w-1/2 md:flex-shrink-0 [&>div]:!bg-transparent [&>div]:!border-0 [&>div]:!rounded-none [&>div]:!p-0 [&>div>div]:!bg-transparent [&>div>div]:!border-0 [&>div>div]:!rounded-none [&>div>div]:!p-0 [&>div>.absolute]:!hidden">
        ...
        {/* Nome, @ e Depoimento */}
        <div className="px-5 py-4 md:p-6 flex flex-col justify-center md:justify-start md:w-1/2">
