      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="md:hidden px-2">
          <Carousel opts={{ watchDrag: false }} className="w-full max-w-sm mx-auto">
            ...
            <CarouselPrevious className="-left-2 h-10 w-10 bg-accent0 hover:bg-slate-600 border-none text-white shadow-lg shadow-slate-500/20" />
            <CarouselNext className="-right-2 h-10 w-10 bg-accent0 hover:bg-slate-600 border-none text-white shadow-lg shadow-slate-500/20" />
          </Carousel>
        </div>
