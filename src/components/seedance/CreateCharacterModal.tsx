        ...
        {step === 'upload' && (
          <div className="space-y-4 pt-2">
            ...
            <Button
              ...
              className="w-full bg-gradient-to-r from-purple-600 to-purple-500 hover:from-purple-500 hover:to-purple-400 text-white text-[12px]"
            >
          ...
          <div className="space-y-4 pt-2">
            ...
            <div className="flex gap-2">
              ...
              <Button
                ...
                className="flex-1 bg-gradient-to-r from-purple-600 to-purple-500 hover:from-purple-500 hover:to-purple-400 text-white text-[11px]"
              >
