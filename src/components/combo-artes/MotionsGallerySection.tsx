  ...
  return <section className="py-5 md:py-10 px-4 bg-black">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mt-8 md:mt-10">
          ...
          <div className="flex flex-wrap justify-center items-center gap-4 mt-2 mb-12">
            <img src="https://voxvisual.com.br/wp-content/uploads/2025/11/greenn-compra-segura.png" alt="Compra Segura" className="h-5 md:h-6 object-contain" />
          </div>
        </div>
      </div>
      ...
      {showPaymentMethodModal && (
        <PaymentMethodModal
          ...
          onOpenChange={(open) => { if (!open) setShowPaymentMethodModal(false); }}
