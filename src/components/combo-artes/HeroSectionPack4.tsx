...
export const HeroSectionPack4 = () => {
  return (
    <section className="relative flex flex-col items-center justify-center pt-14 pb-8 md:pt-16 md:pb-12 px-4 overflow-hidden">
      {/* Background gradient */}
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center flex flex-col items-center">
        ...
        <div className="flex items-center gap-1 md:gap-2 bg-gradient-to-r from-[#3d1515]/80 to-[#2a0f0f]/80 backdrop-blur-sm border border-[#EF672C]/30 rounded-full px-2 md:px-3 py-0.5 md:py-1 mb-3 md:mb-5">
          <img
            ...
            alt="Membros"
            className="w-14 md:w-12 h-14 md:h-12 object-contain -my-3 md:-my-1"
          />
        ...
        <h1 className="text-2xl md:text-4xl lg:text-5xl font-black mb-0 leading-tight">
          <span className="text-[#EF672C]">Novo Lançamento</span>{" "}
          <span className="text-white">- Pack Arcano Vol. 4</span>
        </h1>
        ...
        <img
          ...
          className="max-w-[60%] w-full object-contain"
          width={768}
          height={432}
          fetchPriority="high"
        />
        ...
        {/* Subtitle - changed */}
        <p className="text-lg md:text-3xl text-gray-300 mb-6 text-center">
          <span className="text-[#EF672C] font-bold">Artes Inéditas editáveis psd e canva</span>
        </p>
