    ...
    <section className="relative flex flex-col items-center justify-center py-8 md:py-12 px-4 overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center flex flex-col items-center">
        ...
        <img
          ...
          alt="Área de Membros"
          className="-mt-6 md:mt-4 mb-4 max-w-3xl w-full object-contain"
        />
        
        {/* Subtitle */}
        <p className="text-lg md:text-xl text-gray-300 mb-6 max-w-2xl">Conheça nossa plataforma com <span className="text-[#EF672C] font-bold">+ de 380 Artes Editáveis PSD e CANVA!</span></p>
