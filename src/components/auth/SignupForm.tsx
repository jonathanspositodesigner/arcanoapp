...
const variantStyles = {
  ...
  dark: {
    ...
    stepActive: 'bg-emerald-500 text-primary-foreground',
    stepInactive: 'bg-muted text-muted-foreground',
    stepDone: 'bg-emerald-500/60 text-primary-foreground',
  },
  purple: {
    container: 'bg-card border-border',
    ...
    button: 'bg-green-600 hover:bg-green-700 text-primary-foreground',
    backButton: 'text-muted-foreground hover:text-foreground hover:bg-accent',
    progressBg: 'bg-green-500/20',
    progressFill: 'bg-green-500',
    stepActive: 'bg-green-500 text-primary-foreground',
    stepInactive: 'bg-accent text-muted-foreground',
    stepDone: 'bg-green-500/60 text-primary-foreground',
  },
  teal: {
    container: 'bg-card border-border',
    header: 'bg-emerald-500/20 border-b border-emerald-500/30',
    ...
    label: 'text-foreground',
    input: 'bg-card border-border text-foreground placeholder:text-muted-foreground',
    alert: 'bg-accent border-border',
    alertIcon: 'text-muted-foreground',
