...
const PersonInputSwitch: React.FC<PersonInputSwitchProps> = ({
  ...
  const [mode, setMode] = useState<'character' | 'photo'>('photo');
        ...
        <Card className="bg-accent border-border p-2">
          {isLoading ? (
            ...
            <div className="flex flex-col items-center gap-2 py-4">
              ...
              <Button
                size="sm"
                className="h-7 text-[10px] bg-slate-600 hover:bg-accent0 text-white font-semibold border-0"
            ...
            <>
              ...
              <Button
                size="sm"
                className="w-full h-6 mt-1.5 text-[10px] bg-slate-600 hover:bg-accent0 text-white font-semibold border-0"
                onClick={() => navigate('/gerador-avatar')}
              >
                <Plus className="w-3 h-3 mr-1" />
                Gerar Novo Avatar
