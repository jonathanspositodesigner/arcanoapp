...
const EmailMarketingContent = ({ platform }: EmailMarketingContentProps) => {
  ...
  return (
    <div>
          ...
          <Card className="p-6">
            ...
            {templates.length === 0 ? (
              <div className="text-center py-12 text-muted-foreground">
                ...
                <p className="text-sm mt-1">Crie uma campanha e salve como modelo</p>
              </div>
            ) : (
              <div className="space-y-3">
      ...
      <AlertDialog open={!!deleteTemplateConfirm} onOpenChange={() => setDeleteTemplateConfirm(null)}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Tem certeza que deseja excluir o modelo "{deleteTemplateConfirm?.name}"?
      ...
      <Dialog open={showProgressModal} onOpenChange={handleProgressClose}>
