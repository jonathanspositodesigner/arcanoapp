  ...
  return (
    <div className="space-y-2 pb-1">
      <Textarea
        ...
        rows={4}
        className="bg-black/20 border-white/[0.06] text-gray-300 text-[12px] min-h-[80px] resize-none placeholder:text-gray-400 focus:min-h-[120px] transition-all duration-200"
      />
      <div className="flex justify-end">
        <span className="text-[10px] text-gray-400">{settings.scenePrompt.length}/2000</span>
      </div>
    </div>
  );
};
