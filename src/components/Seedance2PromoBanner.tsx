  ...
  return (
    <div className="mb-6 sm:mb-8 relative w-full rounded-2xl overflow-hidden border border-border">
      <div className="relative w-full aspect-[4/3] sm:aspect-[16/5]">
        ...
        <div className="absolute inset-0 bg-gradient-to-t sm:bg-gradient-to-r from-black/85 via-black/60 to-transparent" />
        <div className="absolute inset-0 flex items-end sm:items-center">
          <div className="p-4 sm:p-10 lg:p-14 w-full sm:max-w-xl">
            ...
            <p className="text-[10px] sm:text-sm lg:text-base text-white/90 mb-3 sm:mb-8 leading-relaxed">
              {t('banner.upscalerDescription')}
            </p>
            <div className="flex flex-row items-center gap-3 sm:gap-4">
              <Button onClick={() => navigate("/seedance2")} className="bg-white/15 hover:bg-white/25 text-white border border-white/30 backdrop-blur-sm px-4 py-2 sm:px-8 sm:py-6 text-xs sm:text-base font-semibold rounded-lg transition-all hover:scale-105">
                {t('banner.buyNow')}
              </Button>
            </div>
          </div>
