          ...
          <div className="space-y-3 mb-6">
            <div className="flex items-start gap-3 p-3 rounded-lg bg-muted/50">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">Ele ganha <span className="font-bold text-green-500">500 créditos vitalícios</span></p>
              </div>
            </div>
            <div className="flex items-start gap-3 p-3 rounded-lg bg-muted/50">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">Receba <span className="font-bold text-green-500">500 créditos vitalícios</span> por cada indicação</p>
              </div>
            </div>
          </div>
