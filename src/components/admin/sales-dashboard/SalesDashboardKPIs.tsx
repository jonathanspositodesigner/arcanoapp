...
const cards = [
  ...
  { key: "profit", label: "Lucro", icon: BarChart3, gradient: "from-slate-500/20 to-slate-400/5", iconBg: "bg-white/50/20", iconColor: "text-gray-400", valueColor: "text-gray-400" },
];
