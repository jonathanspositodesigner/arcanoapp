...
import { 
  ...
  Inbox, Handshake, Tag, Package, 
  Image, Gift, FileSearch, UserPlus,
...
const ArtesEventosFerramentasContent = () => {
  ...
  const { isReordering, setIsReordering, resetOrder, getDragProps } = useDashboardCardOrder("ferramentas_artes_eventos");
  ...
  return (
    <div>
      ...
      {isReordering && (
        <div className="p-3 bg-amber-500/10 border border-amber-500/20 rounded-lg text-center mb-4">
      ...
      <div className={cn(
        ...
        <Card 
          className="p-3 sm:p-8 cursor-pointer hover:shadow-hover transition-all hover:scale-105 relative"
          onClick={() => !isReordering && navigate('/admin-import-clients')}
          {...getDragProps("importar")}
        >
          {isReordering && (
            <div className="absolute top-2 right-2 z-10 p-1 bg-amber-500/20 rounded-md">
              <GripVertical className="h-4 w-4 text-amber-500" />
        ...
        <Card 
          className="p-3 sm:p-8 cursor-pointer hover:shadow-hover transition-all hover:scale-105 relative"
          onClick={() => !isReordering && navigate('/admin-manage-promotions')}
          {...getDragProps("promocoes")}
        >
          {isReordering && (
            <div className="absolute top-2 right-2 z-10 p-1 bg-amber-500/20 rounded-md">
              <GripVertical className="h-4 w-4 text-amber-500" />
        ...
        <Card 
          className="p-3 sm:p-8 cursor-pointer hover:shadow-hover transition-all hover:scale-105 relative"
          onClick={() => !isReordering && navigate('/admin-webhook-logs')}
          {...getDragProps("webhook-logs")}
        >
          {isReordering && (
            <div className="absolute top-2 right-2 z-10 p-1 bg-amber-500/20 rounded-md">
              <GripVertical className="h-4 w-4 text-amber-500" />
        ...
        <Card 
          className="p-3 sm:p-8 cursor-pointer hover:shadow-hover transition-all hover:scale-105 relative"
          onClick={() => !isReordering && navigate('/admin-blacklist')}
          {...getDragProps("blacklist")}
        >
          {isReordering && (
            <div className="absolute top-2 right-2 z-10 p-1 bg-amber-500/20 rounded-md">
              <GripVertical className="h-4 w-4 text-amber-500" />
...
export default ArtesEventosFerramentasContent;
