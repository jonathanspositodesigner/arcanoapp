...
export const checkoutProducts: CheckoutProductConfig[] = [
  ...
  { slug: 'plano-ultimate-anual', title: 'Plano Ultimate Anual', priceInCents: 71880, currency: 'brl', provider: 'pagarme', currentCheckoutSlug: 'plano-ultimate-anual', stripePriceId: 'price_1TKk67L0tOYcQz0tHZ8EDJCx', stripeMode: 'subscription', isActive: true, type: 'subscription' },
  { slug: 'plano-ultimate-mensal', title: 'Plano Ultimate Mensal', priceInCents: 7990, currency: 'brl', provider: 'pagarme', currentCheckoutSlug: 'plano-ultimate-mensal', stripePriceId: 'price_1TKk66L0tOYcQz0t51KKbFjk', stripeMode: 'subscription', isActive: true, type: 'subscription' },
