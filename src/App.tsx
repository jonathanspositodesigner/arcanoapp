...
const PartnerComoGanhar = lazy(() => import("./pages/PartnerComoGanhar"));
...
const PlanosUpscalerCreditos = lazy(() => import("./pages/PlanosUpscalerCreditos"));
    ...
    <TooltipProvider>
      ...
      <Suspense fallback={<LoadingSpinner />}>
        <Routes>
          ...
          <Route path="/admin-prompts/debug-ia" element={<Navigate to="/admin-prompts/motores-ia" replace />} />
          <Route path="/admin-prompts/api-google" element={<Navigate to="/admin-prompts/motores-ia" replace />} />
          ...
          <Route path="/parceiro-como-ganhar" element={<PartnerComoGanhar />} />
          ...
          <Route path="/planos-upscaler-creditos" element={<PlanosUpscalerCreditos />} />
