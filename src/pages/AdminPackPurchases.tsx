                              ...
                              <div className="flex flex-wrap gap-4 text-xs text-muted-foreground bg-muted/50 rounded-lg p-2">
                                ...
                                <div className="flex items-center gap-1">
                                  {access.access_type === 'vitalicio' ? (
                                    <Badge variant="outline" className="text-xs bg-slate-500/10 text-purple-600 border-purple-500/30">
                                      Acesso Vitalício
                                    </Badge>
                                  ) : access.expires_at ? (
                                    <>
                  ...
                  <TableRow key={client.user_id}>
                    ...
                    <TableCell>
                      {client.has_vitalicio ? (
                        <Badge variant="outline" className="bg-slate-500/10 text-purple-600 border-purple-500/30 text-xs">Vitalício</Badge>
