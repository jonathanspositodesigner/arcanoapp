    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-[#111113] to-[#1A0A2E] px-4 py-6">
      <div className="text-center space-y-6 sm:space-y-8 w-full max-w-2xl">
        <div className="space-y-3 sm:space-y-4">
          ...
          <h1 className="text-2xl sm:text-4xl md:text-5xl font-bold bg-gradient-to-r dark:from-gray-400 dark:to-pink-400 from-purple-700 to-pink-600 bg-clip-text text-transparent px-2">
            {t('promptverso.title')}
          </h1>
      ...
      <Dialog open={showBAAModal} onOpenChange={setShowBAAModal}>
        <DialogContent className="sm:max-w-md bg-background border-border">
          ...
          <div className="flex flex-col gap-3 mt-4">
            <Button onClick={() => window.open("https://blibliotecadeartesarcanas.greenn.club/", "_blank")} className="bg-secondary hover:bg-secondary py-6 text-foreground">
