          ...
          <div className="mt-auto flex flex-col items-center">
            ...
            <FadeIn duration={700}>
              <button
                ...
                className="mb-6 px-8 py-3 rounded-xl bg-gradient-to-r from-purple-600 to-purple-500 hover:from-purple-500 hover:to-purple-400 text-white font-bold text-sm md:text-base transition-all pointer-events-auto"
              >
