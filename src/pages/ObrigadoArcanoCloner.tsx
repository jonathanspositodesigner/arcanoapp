  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0f0a15] via-[#1a0f25] to-[#0a0510] font-space-grotesk relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[600px] h-[600px] bg-muted/10 rounded-full blur-[120px]" />
        <div className="absolute bottom-1/4 left-1/4 w-[400px] h-[400px] bg-muted/10 rounded-full blur-[100px]" />
      </div>
      ...
      <div className="relative z-10 flex flex-col items-center px-4 py-12 max-w-3xl mx-auto">
        ...
        <div className="w-full bg-accent border border-border rounded-3xl p-8 md:p-12 flex flex-col items-center text-center mb-8">
          ...
          {/* Subtitle */}
          <p className="text-xl md:text-2xl font-semibold bg-gradient-to-r dark:from-gray-400 dark:to-slate-400 from-purple-700 to-purple-500 bg-clip-text text-transparent mb-6">
