                    ...
                    <div className="relative">
                      ...
                      {showCharacterTip && selectedCharacters.length === 0 && (
                        <div className="absolute top-full left-1/2 -translate-x-1/2 mt-2 z-50 animate-bounce">
                          <div className="relative rounded-xl px-4 py-2.5 shadow-[0_0_20px_rgba(147,51,234,0.5)] whitespace-nowrap bg-gradient-to-r from-purple-600 via-fuchsia-500 to-purple-600 bg-[length:200%_100%] animate-[shimmer_2s_linear_infinite]">
