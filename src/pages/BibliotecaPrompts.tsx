        ...
        <div className="mb-6 sm:mb-8">
          ...
          <div className="relative group/carousel">
            ...
            {[
              ...
              { name: 'Gerar Imagem', desc: 'Crie imagens do zero com IA', cost: 60, path: '/gerar-imagem', cover: 'https://images.unsplash.com/photo-1686191128892-3261bf2f1e3b?w=400&h=225&fit=crop&q=80' },
              { name: 'Gerar Vídeo', desc: 'Gere vídeos com Veo 3.1 e WAN 2.2', cost: 127, path: '/gerar-video', video: '/videos/seedance2-promo.mp4' },
