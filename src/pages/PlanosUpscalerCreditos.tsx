              ...
              >
                ...
                <div className="flex flex-col h-full w-full">
                  <Card className="relative p-8 flex flex-col rounded-xl bg-background border border-border w-full h-full">
                    ...
                    <ul className="space-y-3 flex-1">
                      ...
                      <li className="flex items-start gap-2.5 text-base">
                        <X className="w-5 h-5 text-orange-500 shrink-0 mt-0.5" />
                ...
                <div className="flex flex-col h-full w-full">
                  <Card className="relative p-8 flex flex-col rounded-xl bg-background border-2 border-lime-400 shadow-lg shadow-lime-400/30 w-full h-full">
                    ...
                    <Button 
                      ...
                      className="w-full mb-5 text-lg h-14 bg-gradient-to-r from-lime-400 to-lime-500 hover:from-lime-500 hover:to-lime-600 text-black font-semibold"
                    >
                      Comprar
                    </Button>
                    <div className="flex flex-col items-center mb-6 h-[57px]">
                ...
                <div className="flex flex-col h-full w-full">
                  <Card className="relative p-8 flex flex-col rounded-xl bg-background border-2 border-slate-500 shadow-lg shadow-primary/10 w-full h-full">
                    <Badge className="absolute -top-3.5 left-1/2 -translate-x-1/2 border-0 text-sm whitespace-nowrap bg-gradient-to-r from-purple-600 to-purple-500 text-white px-5 py-1.5">
                    ...
                    <Button 
                      ...
                      className="w-full mb-5 text-lg h-14 bg-gradient-to-r from-purple-600 to-purple-500 hover:from-purple-500 hover:to-purple-400 text-white font-semibold"
                    >
                      Comprar
                    </Button>
                    <div className="flex flex-col items-center mb-6 h-[57px]">
