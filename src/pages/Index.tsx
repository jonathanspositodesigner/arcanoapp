...
const Index = () => {
  ...
  const DiscoverCard = ({ card }: { card: CardData }) => (
    <div 
      className="group bg-card border border-border rounded-xl overflow-hidden shadow-md hover:shadow-lg transition-all duration-300 hover:border-primary/50 relative"
    >
      {/* Imagem compacta */}
  ...
  const PurchasedCard = ({ card }: { card: CardData }) => (
    <div 
      className="group bg-card border-2 border-green-500/30 rounded-xl overflow-hidden shadow-md hover:shadow-lg transition-all duration-300 hover:border-green-500/50 relative"
    >
  ...
  const AvailableCard = ({ card, isComingSoon }: { card: CardData; isComingSoon: boolean }) => (
    <div 
      className={`group bg-card border border-border rounded-xl overflow-hidden shadow-md transition-all duration-300 relative ${
        isComingSoon 
