...
const CTAButton = ({ onClick, isPremium, t }: { onClick: () => void; isPremium: boolean; t: (key: string) => string }) => (
  <Button
    onClick={onClick}
    className="w-full max-w-md py-6 text-lg font-bold rounded-full bg-gradient-to-r from-purple-500 to-purple-500 hover:from-purple-600 hover:to-purple-600 text-white shadow-2xl shadow-primary/10 transition-all duration-300 hover:scale-[1.02] hover:shadow-primary/10"
  >
        ...
        <>
          ...
          <section className="px-3 md:px-4 py-10 md:py-20 w-full">
            <div className="flex flex-col items-center text-center">
              ...
              <FadeIn delay={400} duration={700}>
                <p className="text-base md:text-lg lg:text-xl text-purple-200/80 mb-6 md:mb-8 max-w-2xl">
                  {t('tools:upscaler.hero.subtitle')} <span className="text-purple-200/80 font-semibold">{t('tools:upscaler.hero.sharp')}</span>
                </p>
              </FadeIn>
            ...
            <div className="max-w-5xl mx-auto">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-4 md:gap-6 items-stretch">
                <AnimatedElement className="h-full lg:col-span-2" delay={0}>
                  <div className="bg-purple-900/40 border border-purple-500/30 rounded-3xl p-6 md:p-8 text-center hover:border-purple-500/30 transition-all duration-300 flex flex-col items-center justify-center h-full lg:min-h-[200px]">
                    <div className="text-4xl md:text-5xl mb-4 md:mb-6">📱</div>
                    <p className="text-white text-base md:text-lg">
                      {t('tools:upscaler.pain.phone')} <span className="text-purple-200/80 font-semibold">{t('tools:upscaler.pain.bad')}</span>?
                    </p>
                  </div>
                </AnimatedElement>
                ...
                <AnimatedElement className="h-full lg:col-span-2" delay={100}>
                  <div className="bg-purple-900/40 border border-purple-500/30 rounded-3xl p-6 md:p-8 text-center hover:border-purple-500/30 transition-all duration-300 flex flex-col items-center justify-center h-full lg:min-h-[200px]">
                    <div className="text-4xl md:text-5xl mb-4 md:mb-6">😤</div>
                    <p className="text-white text-base md:text-lg">
                      {t('tools:upscaler.pain.client')} <span className="text-purple-200/80 font-semibold">{t('tools:upscaler.pain.lowQuality')}</span>?
                    </p>
                  </div>
                </AnimatedElement>
                ...
                <AnimatedElement className="h-full lg:col-span-2" delay={200}>
                  <div className="bg-purple-900/40 border border-purple-500/30 rounded-3xl p-6 md:p-8 text-center hover:border-purple-500/30 transition-all duration-300 flex flex-col items-center justify-center h-full lg:min-h-[200px]">
                    <div className="text-4xl md:text-5xl mb-4 md:mb-6">📷</div>
                    <p className="text-white text-base md:text-lg">
                      {t('tools:upscaler.pain.aiGenerated')} <span className="text-purple-200/80 font-semibold">{t('tools:upscaler.pain.notGood')}</span>?
                    </p>
                  </div>
                </AnimatedElement>
                ...
                <AnimatedElement className="h-full lg:col-span-2 lg:col-start-2" delay={300}>
                  <div className="bg-purple-900/40 border border-purple-500/30 rounded-3xl p-6 md:p-8 text-center hover:border-purple-500/30 transition-all duration-300 flex flex-col items-center justify-center h-full lg:min-h-[200px]">
                    <div className="text-4xl md:text-5xl mb-4 md:mb-6">🤖</div>
                    <p className="text-white text-base md:text-lg">
                      {t('tools:upscaler.pain.aiImage')} <span className="text-purple-200/80 font-semibold">{t('tools:upscaler.pain.aiNotGood')}</span>?
                    </p>
                  </div>
                </AnimatedElement>
                ...
                <AnimatedElement className="h-full lg:col-span-2 lg:col-start-4" delay={400}>
                  <div className="bg-purple-900/40 border border-purple-500/30 rounded-3xl p-6 md:p-8 text-center hover:border-purple-500/30 transition-all duration-300 flex flex-col items-center justify-center h-full lg:min-h-[200px]">
                    <div className="text-4xl md:text-5xl mb-4 md:mb-6">🎸</div>
                    <p className="text-white text-base md:text-lg">
                      {t('tools:upscaler.pain.lostContract')} <span className="text-purple-200/80 font-semibold">{t('tools:upscaler.pain.noProPhotos')}</span>?
                    </p>
                  </div>
                </AnimatedElement>
              </div>
              ...
              <StaggeredAnimation className="grid md:grid-cols-3 gap-6" staggerDelay={150}>
                {targetAudience.map((item, index) => {
                  ...
                  return (
                    <div 
                      key={index}
                      className="bg-gradient-to-br from-purple-500/10 to-purple-900/20 border border-purple-500/30 rounded-3xl p-8 text-center hover:border-purple-400/30 transition-all duration-300 hover:transform hover:scale-[1.02] h-full flex flex-col"
                    >
                      <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-purple-500/20 to-purple-400/20 flex items-center justify-center mx-auto mb-6">
                        <IconComponent className="h-8 w-8 text-purple-200/80" />
                      </div>
                      <h3 className="text-xl font-semibold text-white mb-3">{item.title}</h3>
                      <p className="text-purple-200/80 flex-1">{item.description}</p>
                    </div>
                  );
                })}
              </StaggeredAnimation>
          ...
          <AnimatedSection className="px-4 py-20">
            <div className="max-w-4xl mx-auto">
              <AnimatedSection as="div" delay={100}>
                <h2 className="font-bebas text-3xl md:text-4xl lg:text-5xl text-white text-center mb-12 tracking-wide">
                  {t('tools:upscaler.howItWorks.title')} <span className="text-purple-200/80">{t('tools:upscaler.howItWorks.subtitle')}</span>
                </h2>
              </AnimatedSection>
                ...
                {steps.map((step, index) => {
                  ...
                  return (
                    <div key={index} className="text-center flex flex-col items-center relative">
                      ...
                      <div className="w-20 h-20 rounded-3xl bg-gradient-to-br from-purple-500/20 to-purple-400/20 border border-purple-500/30 flex items-center justify-center mb-5">
                        <IconComponent className="h-10 w-10 text-purple-200/80" />
                      </div>
                      <h3 className="text-xl font-semibold text-white mb-2">{step.title}</h3>
                      <p className="text-purple-200/80 max-w-[180px]">{step.description}</p>
                    </div>
                  );
                })}
              </StaggeredAnimation>
              ...
              <Card className="bg-gradient-to-br from-[#1a0f25] to-[#150a1a] border-2 border-purple-500/30 rounded-3xl overflow-hidden shadow-2xl shadow-primary/5">
                <CardContent className="p-5 md:p-8 text-center">
                  ...
                  <h2 className="font-bebas text-2xl md:text-3xl lg:text-4xl text-white mb-4 md:mb-6 tracking-wide">
                    {t('tools:upscaler.finalCTA.title')} <span className="text-purple-200/80">{t('tools:upscaler.finalCTA.subtitle')}</span>
                  </h2>

                  {/* Preços em dólar */}
                  <div className="mb-5 md:mb-6">
                    <span className="text-purple-300/50 text-lg md:text-xl line-through block mb-1">{formatPrice(originalPrice)}</span>
                    <div className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-2">
                      {formatPrice(price)}
                    </div>
                    <p className="text-purple-200/80 text-base md:text-lg">
                      {t('tools:upscaler.finalCTA.or')} <span className="text-purple-200/80 font-semibold">3x {formatPrice(installmentPrice)}</span>
                    </p>
                    <p className="text-purple-300/50 text-xs md:text-sm mt-2">{t('tools:upscaler.finalCTA.oneTimePayment')}</p>
                    {conversion && (
                  ...
                  {/* Alerta de urgência */}
                  <div className="bg-purple-500/10 border border-purple-500/30 rounded-xl md:rounded-2xl p-2.5 md:p-3 mb-5 md:mb-6">
                    <div className="flex items-center justify-center gap-2 text-purple-200/80 text-xs md:text-sm">
                  ...
                  <div className="flex flex-wrap justify-center gap-3 md:gap-4 mt-5 md:mt-6 text-purple-200/80 text-xs">
          ...
          <AnimatedSection className="px-4 py-20 bg-purple-900/20">
            <div className="max-w-4xl mx-auto">
              <AnimatedSection as="div" delay={100}>
                <h2 className="font-bebas text-3xl md:text-4xl lg:text-5xl text-white text-center mb-12 tracking-wide">
                  {t('tools:upscaler.benefits.title')} <span className="text-purple-200/80">{t('tools:upscaler.benefits.subtitle')}</span>?
                </h2>
              </AnimatedSection>
              ...
              <StaggeredAnimation className="grid sm:grid-cols-2 gap-6 max-w-2xl mx-auto" staggerDelay={100}>
                {features.map((feature, index) => {
                  ...
                  return (
                    <div 
                      key={index}
                      className="flex items-center gap-4 bg-purple-900/40 border border-purple-500/30 rounded-2xl p-5 hover:border-purple-500/30 transition-all duration-300"
                    >
                      <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-purple-500/20 to-purple-400/20 flex items-center justify-center flex-shrink-0">
                        <IconComponent className="h-6 w-6 text-purple-200/80" />
                      </div>
          ...
          <AnimatedSection className="px-4 py-20">
            <div className="max-w-2xl mx-auto">
              <AnimatedSection as="div" delay={100}>
                <h2 className="font-bebas text-3xl md:text-4xl lg:text-5xl text-white text-center mb-12 tracking-wide">
                  {t('tools:upscaler.faq.title')} <span className="text-purple-200/80">{t('tools:upscaler.faq.subtitle')}</span>
                </h2>
              </AnimatedSection>
...
export default PlanosUpscalerArcano69ES;