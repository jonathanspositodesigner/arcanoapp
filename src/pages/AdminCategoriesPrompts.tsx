...
import { ArrowLeft, Plus, Pencil, Trash2, GripVertical, Shield } from "lucide-react";
    ...
    <div className="min-h-screen bg-background">
      <div className="container max-w-2xl mx-auto py-8 px-4">
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="text-3xl font-bold text-foreground">Categorias de Prompts</h1>
            <p className="text-muted-foreground">Gerencie as categorias da Biblioteca de Prompts</p>
          </div>
          ...
          <div className="space-y-4">
            <div>
              ...
              <Input
                ...
                placeholder="Ex: Selos 3D"
                className="mt-2"
              />
            </div>
            <div className="flex items-center justify-between p-3 rounded-lg border bg-secondary/50">
              <div className="flex items-center gap-2">
                <Shield className={`h-4 w-4 ${isAdminOnly ? 'text-primary' : 'text-muted-foreground'}`} />
                <Label className="font-medium">
                  {isAdminOnly ? 'Apenas Admin' : 'Disponível para todos'}
                </Label>
              </div>
              <Switch checked={isAdminOnly} onCheckedChange={setIsAdminOnly} />
            </div>
            <p className="text-xs text-muted-foreground">
              Categorias "Apenas Admin" só podem receber uploads de administradores.
            </p>
...
export default AdminCategoriesPrompts;
