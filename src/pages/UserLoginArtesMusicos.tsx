...
const UserLoginArtesMusicos = () => {
  ...
  const redirectTo = searchParams.get('redirect') || '/biblioteca-artes-musicos';

  const auth = useUnifiedAuth({
    changePasswordRoute: '/change-password-artes-musicos',
    loginRoute: '/login-artes-musicos',
    forgotPasswordRoute: '/forgot-password-artes-musicos',
        ...
        <DialogContent className="max-w-md p-0 overflow-hidden border-0">
          <SignupForm
            ...
            labels={{
              ...
              subtitle: t('signupModal.subtitleMusicos'),
              email: t('email'),
              ...
              warning: t('signupModal.afterSignupWarningMusicos'),
