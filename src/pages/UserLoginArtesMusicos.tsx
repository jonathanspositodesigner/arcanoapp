    ...
    try {
      ...
      if (profileExists && !passwordChanged) {
        ...
        if (!autoLoginError) {
          ...
          // Enviar link para criar senha e navegar para /change-password-artes-musicos
          ...
          if (!resetError) {
            // Navegar para /change-password-artes-musicos com parâmetros de "aguardando link"
            navigate(`/change-password-artes-musicos?redirect=${encodeURIComponent(redirectTo)}&sent=1&email=${encodeURIComponent(normalizedEmail)}`);
          } else {
