      ...
      <div>
        ...
        {isLoading ? (
          ...
          <div className={cn(
            ...
            <Card className="p-6 border-2 border-violet-500/30 relative" {...getDragProps("email-analytics")}>
              {isReordering && (
                <div className="absolute top-2 right-2 z-10 p-1 bg-violet-500/20 rounded-md">
                  <GripVertical className="h-4 w-4 text-violet-500" />
                </div>
                    ...
                    <TableBody>
                      {topEmailCampaigns.map((campaign, index) => (
                        <TableRow key={campaign.id}>
                          <TableCell className="font-bold text-violet-500">{index + 1}º</TableCell>
                          <TableCell>
                            <div>
