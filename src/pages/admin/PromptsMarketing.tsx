...
import { Mail, Bell, Eye, Send, CheckCircle, MousePointer, AlertTriangle, RefreshCw, Trophy, GripVertical, LayoutGrid, RotateCcw, ShieldX } from "lucide-react";
...
const PromptsMarketing = () => {
  ...
  const { isReordering, setIsReordering, resetOrder, getDragProps } = useDashboardCardOrder("marketing_prompts");
    ...
    <AdminLayoutPlatform platform="prompts">
      <div>
        <div className="flex items-center justify-between mb-2">
          <h1 className="text-3xl font-bold text-foreground">Marketing - PromptClub</h1>
        ...
        {isLoading ? (
          ...
          <div className={cn(
            ...
            <Card className="p-6 border-2 border-primary/30 relative" {...getDragProps("email-analytics")}>
              {isReordering && (
                <div className="absolute top-2 right-2 z-10 p-1 bg-primary/20 rounded-md">
                  <GripVertical className="h-4 w-4 text-primary" />
                </div>
...
export default PromptsMarketing;
