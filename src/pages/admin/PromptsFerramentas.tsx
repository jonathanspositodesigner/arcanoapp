...
import { 
  ...
  FolderOpen, Inbox, Tag, ShieldCheck, Sparkles,
    ...
    <AdminLayoutPlatform platform="prompts">
      <div>
        <div className="flex items-center justify-between mb-2">
          <div>
            <h1 className="text-3xl font-bold text-foreground">Ferramentas - PromptClub</h1>
            <p className="text-muted-foreground">Gerencie arquivos e contribuições da biblioteca de prompts</p>
          </div>
        </div>
        ...
        <div className={cn(
          ...
          <Card 
            className="p-3 sm:p-8 cursor-pointer hover:shadow-hover transition-all hover:scale-105 relative"
            onClick={() => !isReordering && navigate('/admin-ia-libraries')}
            {...getDragProps("ia-libraries")}
          >
            {isReordering && (
              <div className="absolute top-2 right-2 z-10 p-1 bg-primary/20 rounded-md">
                <GripVertical className="h-4 w-4 text-primary" />
...
export default PromptsFerramentas;
