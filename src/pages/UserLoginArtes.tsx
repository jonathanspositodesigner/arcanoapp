...
import { Eye, EyeOff, ArrowLeft, AlertCircle, Mail, Lock, UserPlus } from "lucide-react";
        ...
        <CardContent>
            ...
            <form onSubmit={handleEmailCheck} className="space-y-4">
              ...
              <div className="text-center pt-4 border-t border-[#2d4a5e]/30">
                ...
                <Button
                  type="button"
                  variant="outline"
                  className="w-full border-emerald-500/50 text-emerald-400 hover:bg-emerald-500/20"
          ...
          {loginStep === 'password' && (
            <form onSubmit={handlePasswordLogin} className="space-y-4">
              {/* Email indicator */}
              <div className="flex items-center justify-between p-3 bg-[#2d4a5e]/20 rounded-lg border border-[#2d4a5e]/30">
                ...
                <Button
                  ...
                  className="text-amber-400 hover:text-amber-300 text-xs h-auto py-1 px-2"
                >
                  {t('changeEmail')}
                </Button>
              </div>
              ...
              <div className="text-right">
                <Link
                  to={`/forgot-password-artes?email=${encodeURIComponent(verifiedEmail)}`}
