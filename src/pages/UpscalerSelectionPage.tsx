    ...
    <AppLayout>
      ...
      <main className="container mx-auto px-4 py-4 sm:py-8 md:py-16">
        ...
        <div className="text-center mb-6 sm:mb-12">
          ...
          <p className="hidden sm:block text-gray-300 text-lg max-w-xl mx-auto">
        ...
        {/* Bottom info */}
        <p className="hidden sm:block text-center text-gray-500 text-sm mt-12 max-w-md mx-auto">
