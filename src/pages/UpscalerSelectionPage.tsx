  ...
  return (
    <AppLayout>
      ...
      <main className="container mx-auto px-4 py-4 sm:py-8 md:py-16">
        ...
        <div className="grid md:grid-cols-2 gap-3 sm:gap-6 max-w-4xl mx-auto">
          ...
          >
            ...
            <div className="relative">
              ...
              <div className="flex flex-wrap gap-2 mb-3 sm:mb-6">
                <span className="inline-flex items-center gap-1 sm:gap-1.5 px-2 sm:px-3 py-1 sm:py-1.5 rounded-full bg-accent0/20 text-muted-foreground text-xs sm:text-sm">
              ...
              {/* CTA */}
              <div className="flex items-center gap-2 text-muted-foreground group-hover:text-muted-foreground font-medium transition-colors text-sm sm:text-base">
          ...
          >
            ...
            <div className="relative">
              ...
              {/* Features */}
              <div className="flex flex-wrap gap-2 mb-3 sm:mb-6">
                <span className="inline-flex items-center gap-1 sm:gap-1.5 px-2 sm:px-3 py-1 sm:py-1.5 rounded-full bg-accent text-muted-foreground text-xs sm:text-sm">
                  <Zap className="w-3 h-3 sm:w-3.5 sm:h-3.5" />
                  Max 10 segundos
                </span>
                <span className="inline-flex items-center gap-1 sm:gap-1.5 px-2 sm:px-3 py-1 sm:py-1.5 rounded-full bg-accent text-muted-foreground text-xs sm:text-sm">
        ...
        {/* Bottom info */}
        <p className="hidden sm:block text-center text-muted-foreground text-sm mt-12 max-w-md mx-auto">
