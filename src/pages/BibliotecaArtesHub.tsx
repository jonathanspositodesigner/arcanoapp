    ...
    <div className="min-h-screen bg-gradient-to-br from-[#0f0f0f] via-[#1a1a2e] to-[#16213e] flex flex-col items-center justify-center px-4 py-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-8 w-full max-w-3xl">
        ...
        <div onClick={() => navigate("/biblioteca-artes-musicos")} className="group cursor-pointer relative overflow-hidden rounded-2xl p-6 sm:p-8 flex flex-col items-center text-center transition-all duration-300 hover:scale-105 hover:shadow-2xl bg-gradient-to-br from-slate-950/40 to-white/5 border-2 border-white/10 hover:border-white/20">
          ...
          {/* Icon */}
          <div className="relative z-10 w-20 h-20 sm:w-24 sm:h-24 mb-4 sm:mb-6 flex items-center justify-center rounded-full bg-gradient-to-br from-slate-500 to-slate-500 shadow-lg shadow-violet-500/30 group-hover:shadow-violet-400/50 transition-all">
          ...
          {/* Button */}
          <button className="relative z-10 px-6 py-2.5 rounded-full bg-gradient-to-r from-slate-500 to-slate-500 text-white font-medium hover:from-violet-400 hover:to-slate-400 transition-all shadow-md hover:shadow-lg">
            {t('artesHub.access')}
          </button>
        </div>
      </div>
