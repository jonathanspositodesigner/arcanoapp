...
EshotStickyPromoBar.displayName = "EshotStickyPromoBar";
        ...
        <section className="v3-hero">
          ...
          <p className="v3-hero-sub">
            {isMobile ? (
              ...
              <>El Upscaler Arcano transforma cualquier imagen en calidad 4K con IA. Rápido. Simple. Resultado profesional en 60 segundos.</>
            )}
          </p>
            ...
            <div className="eshot-pricing-stack">
              ...
              <div className="v3-plan v3-reveal eshot-guarantee-card">
                <div style={{
                  ...
                  <ShieldCheck size={36} strokeWidth={1.8} style={{ color: "#00e5a0" }} />
                </div>
