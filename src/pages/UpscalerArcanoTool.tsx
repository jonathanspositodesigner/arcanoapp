  ...
  return (
    <AppLayout fullScreen>
      ...
      <div className="flex-1 max-w-7xl w-full mx-auto px-4 py-4 overflow-y-auto flex flex-col">
        <div className="grid grid-cols-1 lg:grid-cols-7 gap-4 lg:gap-5 lg:flex-1 lg:min-h-0">
          
          {/* Left Side - Controls Panel inside ONE card */}
          <div className="lg:col-span-2 flex flex-col pb-2 lg:pb-0 lg:min-h-0">
            <div className="bg-[#1a1a2e] border border-white/10 rounded-2xl p-5 flex flex-col gap-5 lg:overflow-y-auto lg:max-h-[calc(100vh-100px)]"
          ...
          <div className="lg:col-span-5 flex flex-col lg:min-h-0 lg:max-h-[calc(100vh-100px)]">
