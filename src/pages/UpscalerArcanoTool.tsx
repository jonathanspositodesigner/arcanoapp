            ...
            >
              <Tooltip>
                <TooltipTrigger asChild>
                  <ToggleGroupItem 
                    value="standard" 
                    className="w-full py-3 px-4 text-sm sm:text-base rounded-lg data-[state=on]:bg-purple-600/80 data-[state=on]:text-white data-[state=on]:shadow-lg data-[state=on]:ring-2 data-[state=on]:ring-purple-400 text-purple-300 hover:text-purple-100 hover:bg-purple-500/20 transition-all font-medium"
                  >
                    Upscaler Arcano
                  </ToggleGroupItem>
                </TooltipTrigger>
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <ToggleGroupItem 
                    value="pro" 
                    className="w-full py-3 px-4 text-sm sm:text-base rounded-lg data-[state=on]:bg-gradient-to-r data-[state=on]:from-blue-600 data-[state=on]:to-purple-600 data-[state=on]:text-white data-[state=on]:shadow-lg data-[state=on]:ring-2 data-[state=on]:ring-blue-400 text-purple-300 hover:text-purple-100 hover:bg-purple-500/20 transition-all font-medium flex items-center justify-center gap-2"
                  >
                    Upscaler Arcano
