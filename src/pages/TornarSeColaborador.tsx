    ...
    <DialogContent className="max-w-2xl max-h-[80vh]">
      ...
      <ScrollArea className="h-[60vh] pr-4">
        <div className="text-sm text-muted-foreground leading-relaxed space-y-4">
          ...
          <p><strong>5.1. Remuneração por uso de prompt (taxa fixa, mensal por usuário):</strong> O Colaborador recebe um valor fixo por cada prompt seu utilizado em uma ferramenta de IA da Plataforma. A remuneração é <strong>limitada a 1 (uma) vez por usuário, por prompt, por mês calendário</strong>: se o mesmo usuário utilizar o mesmo prompt várias vezes dentro do mesmo mês (em qualquer ferramenta de IA), o Colaborador recebe apenas pela primeira utilização daquele mês. No mês calendário seguinte, se aquele mesmo usuário voltar a utilizar o mesmo prompt, o Colaborador volta a ser remunerado novamente — e assim sucessivamente, todos os meses em que houver uso. Os valores por ferramenta são definidos pela Plataforma e podem ser consultados a qualquer momento no painel do colaborador.</p>
