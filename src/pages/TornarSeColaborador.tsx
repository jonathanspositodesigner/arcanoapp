      ...
      <div className="max-w-4xl mx-auto px-4 pb-16 space-y-20">
        ...
        <section className="space-y-6">
          ...
          <div className="relative overflow-hidden group">
            ...
            <div className="flex gap-6 animate-[scroll-x_30s_linear_infinite] group-hover:[animation-play-state:paused] w-max">
    ...
    <DialogContent className="max-w-2xl max-h-[80vh]">
      ...
      <ScrollArea className="h-[60vh] pr-4">
        <div className="text-sm text-muted-foreground leading-relaxed space-y-4">
          ...
          <p>A remuneração ao Colaborador é condicionada ao uso efetivo de seu Conteúdo por usuários da Plataforma e ocorre de duas formas complementares:</p>
          <p><strong>5.1. Remuneração por uso de prompt (taxa fixa, mensal por usuário):</strong> O Colaborador recebe um valor fixo por cada prompt seu utilizado em uma ferramenta de IA da Plataforma. A remuneração é <strong>limitada a 1 (uma) vez por usuário, por prompt, por mês calendário</strong>, e essa trava é <strong>compartilhada entre todas as ferramentas de IA</strong>: se o mesmo usuário utilizar o mesmo prompt várias vezes no mesmo mês — não importa se em ferramentas diferentes (Gerar Imagem, Flyer Maker, Arcano Cloner, Pose Changer, Veste AI, MovieLED Maker, Seedance 2 etc.) — o Colaborador recebe apenas pela primeira utilização daquele mês. No mês calendário seguinte, se aquele mesmo usuário voltar a utilizar o mesmo prompt em qualquer uma dessas ferramentas, o Colaborador volta a ser remunerado novamente — e assim sucessivamente, todos os meses em que houver uso. Os valores por ferramenta são definidos pela Plataforma e podem ser consultados a qualquer momento no painel do colaborador.</p>
          <p><strong>5.2. Remuneração por consumo (20% recorrente):</strong> Adicionalmente, o Colaborador recebe <strong>20% (vinte por cento) do valor efetivamente gasto</strong> pelo usuário em qualquer ferramenta de IA da Plataforma quando essa geração for feita a partir de um prompt do Colaborador. Diferente da remuneração por uso, esta participação é <strong>recorrente</strong> e se aplica a cada nova geração que o usuário realizar utilizando o prompt do Colaborador.</p>
          <p>A Plataforma se reserva o direito de ajustar os valores, percentuais e critérios de remuneração mediante comunicação prévia de 15 (quinze) dias no painel do colaborador.</p>
