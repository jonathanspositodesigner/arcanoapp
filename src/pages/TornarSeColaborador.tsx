    ...
    <DialogContent className="max-w-2xl max-h-[80vh]">
      ...
      <ScrollArea className="h-[60vh] pr-4">
        <div className="text-sm text-muted-foreground leading-relaxed space-y-4">
          ...
          <p><strong>5.1. Remuneração por uso de prompt (taxa fixa):</strong> O Colaborador recebe um valor fixo por cada prompt seu utilizado em uma ferramenta de IA da Plataforma. O pagamento é <strong>vitalício e único por usuário</strong>: cada usuário gera remuneração apenas <strong>uma única vez</strong> por prompt do Colaborador, independentemente de quantas vezes esse mesmo usuário volte a usar o mesmo prompt no futuro ou em qualquer outra ferramenta. Os valores por ferramenta são definidos pela Plataforma e podem ser consultados a qualquer momento no painel do colaborador.</p>
